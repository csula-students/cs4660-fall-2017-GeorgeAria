...
class AdjacencyList(object):
    ...
    def adjacent(self, node_1, node_2):
        ...
        if node_2 in copy:
            ...
            copy2 = self.adjacency_list[node_2.data]
            if node_1 in copy2:
                return True
            else:
                return False
            ...
            for key in self.adjacency_list:
                if node in self.adjacency_list[key]:
                    for x in range(len(self.adjacency_list[key])):
                        if self.adjacency_list[key][x].data is node.data:
    ...
    def add_edge(self, edge):
        if edge.to_node in self.adjacency_list[edge.from_node.data]:
            return False
        else:
            self.adjacency_list[edge.from_node.data].append(edge.to_node)
            return True
...
class AdjacencyMatrix(object):
    ...
    def neighbors(self, node):
        ...
        for y in range(len(self.adjacency_matrix[index])):
            if self.adjacency_matrix[index][y] is 1:
    ...
    def add_edge(self, edge):
        ...
        if len(self.adjacency_matrix) is 0:
            return False
        if self.adjacency_matrix[index1][index2] is 1:
            return False
        else:
        ...
        for x in range(len(self.edges)):
            if node_1.data is self.edges[x].from_node.data:
                if self.edges[x].to_node.data is node_2.data:
                    return True
            if node_2.data is self.edges[x].from_node.data:
                if self.edges[x].to_node.data is node_1.data:
                    return True
        return False
